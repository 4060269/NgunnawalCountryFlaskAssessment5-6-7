...
from werkzeug.security import generate_password_hash, \
    check_password_hash  # import from werkzeug security to give hashing functionality
...
class todo(db.Model):  # same thing as contact class
    id = db.Column(db.Integer, primary_key=True,
                   autoincrement=True)  # less entries and still auto creates a new id for every entry
